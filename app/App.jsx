...
var App = React.createClass({
  ...
  render: function() {
    ...
    var lip = PlacesStore.getLowInteriorPlateau();
    var bb = PlacesStore.getBlackBelt();
              ...
              <div className="population-map-container" style={{height: this.heights.map + 'px'}}>
                {!this.state.smallmap &&
                  <LeafletMap ref="map"
                    ...
                    {/* JSX Comment <GeoJSONLayer featuregroup={lip} className="ecoregion"  /> */}  
                    <GeoJSONLayer featuregroup={bb} className="ecoregion"  />
